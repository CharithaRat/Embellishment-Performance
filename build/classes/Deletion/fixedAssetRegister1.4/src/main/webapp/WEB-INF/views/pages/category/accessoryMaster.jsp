    ...
    <div class="row" style="margin: 0">
        ...
        <form name="accessoryMasterForm" action="${root}/category/saveAccessoryMaster" method="POST">
                    ...
                    <div class="row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" required name="accerCode" id="accerCodeId" class="form-control" style="width: 100%">
                                </div>
                    ...
                    <div class="row">
                                ...
                                <div class="col-md-8">
                                    <input type="text"required  name="accerName" id="accerNameId" class="form-control" style="width: 100%">
                                </div>
                    </div>
