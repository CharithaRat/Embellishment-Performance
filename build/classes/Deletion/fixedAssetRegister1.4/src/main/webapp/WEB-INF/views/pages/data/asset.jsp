                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <input type="text" id="assetCodeOld " maxlength="45" style="width: 100%" value="${asset.asCodeOld}" name="asCodeOld" />
                            </div>
                            <div class="col-md-3"></div>
                        </div>
                            ...
                            <section id="first-tab-group" class="tabgroup">
                                <div id="tab1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" maxlength="15" style="width: 100%" value="${asset.telephoneNo}" id="telephoneNoId" name="telephoneNo"/>
                                        </div>
                                ...
                                <div id="tab2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" style="width: 100%" value="${asset.originalCost}" name="originalCost" maxlength="24"/>
                                        </div>
                                        <div class="col-md-3"></div>
                                    </div>
                                    <div class="row">
                                ...
                                <div id="tab3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">Authorized Person</div>
                                        <div class="col-md-5">
                                ...
                                <div id="tab5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <input required type="text" maxlength="11" id="lifeTimeId" value="${asset.lifeTime}"
