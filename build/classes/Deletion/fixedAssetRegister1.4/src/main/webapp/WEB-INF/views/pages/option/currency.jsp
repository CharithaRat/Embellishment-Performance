                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="text" id="currencyCodeId" required="required" name="currencyCode" value="${currency.currencyCode}" maxlength="3"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="text" id="descriptionId" required="required" value="${currency.description}" name="description" maxlength="35"
                                       style="width: 100%"/>
                            </div>
                            <div class="col-md-3"></div>
                        </div>
