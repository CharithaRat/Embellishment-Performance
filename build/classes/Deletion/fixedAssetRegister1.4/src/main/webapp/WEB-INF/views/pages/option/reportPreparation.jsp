        ...
        <div class="page">
            ...
            <form id="assetFormID"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class='input-group date'>
                            <input type='text' class="form-control" id="fromDate" required="required" value=""
                                   name="fromDate"/>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class='input-group date'>
                            <input type='text' class="form-control" id="toDate" required="required" value=""
                                   name="toDate"/>
                            <span class="input-group-addon">
                                <button style=height:25px;width:30px> <i style="font-size:15px;color:#3e71fb" class="fa fa-calendar"></i></button>
                                                <%--<span class="glyphicon glyphicon-calendar"></span>--%>
                ...
                <div class="row">
                    <div class="col-md-3" style="">Currency Type</div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-primary" id="doPreparation" style="width: 100%">
                                    Ok
                                </button>
                            </div>
