        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="col-md-5">
                        <div class="row">
                            ...
                            <div class="col-md-8" id="divAsset">
                                <select required id="assetCodeId"
                                        name="assertId" onchange="getAssetAlocation(),checkDisposalDate()"
                                        style="width: 95%">
                                    <option value="">---SELECT---</option>
                                </select>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="row">
                            <div class="col-md-4">Issued To</div>
                        ...
                        <div class="row" style="padding-top: 10px">
                            ...
                            <div class="col-md-3">
                                <button type="button" id="btnDepartmentTransfer" class="btn btn-primary"
                                        style="width: 100%">Volume Transfer
                                </button>
                            </div>
                            <div class="col-md-3">
