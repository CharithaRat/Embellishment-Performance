        ...
        <div class="page">
            <form name="" action="${root}/report/genarateFinalSummary" target="_blank" id="formFinalSummary" method="GET">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-4">Class of Asset </div>
                            <div class="col-md-8">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-7" style="margin-left: -30px">
                                <input type="text" name="fromDate" readonly style="width: 100%" value="${fromDate}"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-7">
                                <input type="text" name="toDate" readonly style="width: 100%" value="${toDate}"/>
                            </div>
                            ...
                            <div class="col-md-4">
                                <c:choose>
                                    <c:when test="${doPreparate}">
                                        <button type="submit" disabled class="btn btn-primary" style="width: 100%">Ok</button>
                                    </c:when>
                                    <c:otherwise>
