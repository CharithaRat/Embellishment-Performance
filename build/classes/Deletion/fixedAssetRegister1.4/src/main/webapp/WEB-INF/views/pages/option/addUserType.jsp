...
<div class="row">
    <div class="col-md-7">
        <div class="page">
            <form name="userType"
                  action="${root}/user/saveUserType" method="post">
                <div class="row" style="margin: 0">
                    <legend>Create User Type</legend>
                </div>
                <input type="hidden" name="userTypeId" value="${userType.userTypeId}"/>
                <div class="row">
                    <div class="col-md-3">User Type</div>
                    <div class="col-md-6">
                        <input type="text" id="userTypeId" value="${userType.userType}" required="required"
                ...
                <div class="row" style="margin-top: 15px">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <a class="btn btn-primary" style="width: 100%" href="${root}/user/userType">New</a>
                            </div>
                            <div class="col-md-6">
                                <c:choose>
