            ...
            <form name="locationForm" id="locationFormID"
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-4">Department Code (Branch)</div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-4">Section Code</div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-4">City Code</div>
                            <div class="col-md-6">
                                <select id="cityID" onblur="loadBuilding()" required style="width: 100%">
                                    <option value="">---SELECT---</option>
                                    <c:forEach var="citys" items="${citys}">
                                        <c:choose>
                                            <c:when test="${citys.cityId == location.room.flow.building.city.cityId}">
                        ...
                        <div class="row">
                            <div class="col-md-4">Building Code</div>
                            <div class="col-md-6">
                                <select id="buildingId" onblur="loadFlow()" required style="width: 100%">
                                    <option value="">---SELECT---</option>
                                    <c:if test="${location.room.flow.building.id > 0}">
                                        <option selected="selected"
                                                value="${location.room.flow.building.id}">${location.room.flow.building.buildingCode}
                                            - ${location.room.flow.building.description}</option>
                                    </c:if>
                                </select>
                            </div>
                            <div class="col-md-2"></div>
                        ...
                        <div class="row">
                            <div class="col-md-4">Floor Code</div>
                            <div class="col-md-6">
                                <select id="flowId" onblur="loadRoom()" required style="width: 100%">
                                    <option value="">---SELECT---</option>
                                    <c:if test="${location.room.flow.id > 0}">
                                        <option selected="selected"
                                                value="${location.room.flow.id}">${location.room.flow.flowCode}
                                            - ${location.room.flow.description}</option>
                                    </c:if>
                                </select>
                            </div>
                            <div class="col-md-2"></div>
                        ...
                        <div class="row">
                            <div class="col-md-4">Room Code</div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <textarea name="locDes" required="required" maxlength="35"
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data == 1) {
                        ...
                        swal(
                            'Sorry!',
                            'Location Code already used !!',
                            'warning'
                        )
                    } else {
                        swal(
                            'Sorry!',
                            'Can\'t Delete Location Code !!',
                            'warning'
                        )
                    }
                }
