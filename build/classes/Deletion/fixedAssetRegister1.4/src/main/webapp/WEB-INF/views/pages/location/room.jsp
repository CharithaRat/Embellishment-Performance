                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <select id="floorId" required name="floor.id" style="width: 100%">
                                    <option value="">---SELECT---</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="text" id="roomCode" class="uppercase" onkeyup="validateCharacter(this)"
                                       onblur="checkRoomCode(this),validateMasterCode(this)"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <textarea name="description" required="required" maxlength="35"
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        if (isEdit == 1) {
            ...
            $("#buildingId").prop("disabled", "disabled");
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data == 1) {
                        ...
                        swal(
                            'Sorry!',
                            'Room Code already used !!',
                            'warning'
                        )
                    } else {
                        swal(
                            'Sorry!',
                            'Can\'t Delete Room Code !!',
                            'warning'
                        )
                    }
                }
