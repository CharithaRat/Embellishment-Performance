...
<div class="row">
    <div class="col-md-12" style="width: 70%">
        <div class="page">
            <form name=""
                  action="${root}/report/genarateDamagedListing" target="_blank" method="post">

                <div class="row" style="margin: 0">
                    <legend>Damaged Listing</legend>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class='input-group date'>
                                    <input type='text' class="form-control" required="required" value="" name="toDate"/>
                                    <span class="input-group-addon">
                                                <span class="glyphicon glyphicon-calendar"></span>
                                                </span>
                                </div>
