    ...
    <div class="col-md-7">
        <div class="page">
            <form name="incomeTaxForm"
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-4">Depreciation Rate</div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-4">Accounting From Year</div>
                            <div class="col-md-6">
         ...
         value = "${incomTax.accFromYear}" />" name="accFromYear"/>
                        ...
                        <div class="row">
                            <div class="col-md-4">Accounting To Year</div>
                            <div class="col-md-6">
            ...
            $.ajax({
                ...
                success: function (data) {
                    if(data == 1) {
                        ...
                        swal(
                            'Sorry!',
                            'Incometax already used !!',
                            'warning'
                        )
                    } else {
                        swal(
                            'Sorry!',
                            'Can\'t Delete Incometax!!',
                            'warning'
                        )
                    }
                }
