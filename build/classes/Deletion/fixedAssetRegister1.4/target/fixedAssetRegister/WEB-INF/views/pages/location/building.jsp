                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="uppercase" id="buildingCode" onkeyup="validateCharacter(this)"
                                       onblur="checkBuildingCode(this),validateMasterCode(this)"
                        ...
                        <div class="row" style="margin-top: 15px">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-6">
                                        <a class="btn btn-primary" style="width: 100%" href="${root}/location/building">New</a>
                                    </div>
                                    <div class="col-md-6">
                                        <c:choose>
