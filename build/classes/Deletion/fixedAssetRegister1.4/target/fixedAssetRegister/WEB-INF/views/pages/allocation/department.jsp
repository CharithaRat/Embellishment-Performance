            ...
            <form name="departmentForm" id="departmentFormID"
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-4">Department / Branch</div>
                            <div class="col-md-6">
                                <input type="text" class="uppercase" id="depCode" onkeyup="validateCharacter(this)"
                                       onblur="checkDepartmentCode(this),validateMasterCode(this)"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <textarea name="depDes" required="required" maxlength="35"
