                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="uppercase" onkeyup="validateCharacter(this)"
                                       onchange="checkFlowCode(this),validateMasterCode(this)"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="text" value="${floor.description}" maxlength="100" required="required"
                        ...
                        <div class="row" style="margin-top: 15px">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-6">
                                        <a class="btn btn-primary" style="width: 100%" href="${root}/location/floor">New</a>
                                    </div>
                                    <div class="col-md-6">
                                        <c:choose>
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data == 1) {
                        ...
                        swal(
                            'Sorry!',
                            'Floor Code already used !!',
                            'warning'
                        )
                    } else {
                        swal(
                            'Sorry!',
                            'Can\'t Delete Section Code !!',
                            'warning'
                        )
                    }
                }
