            ...
            if (detaiCatId > 0) {
                $.ajax({
                    ...
                    success: function (data) {
                        var markup = "";
                        markup += "<tr>";
                        markup += "<td><input type='hidden' name='detailId' value='" + detaiCatId + "'/> <input type='text' readonly style='width: 100%' value='" + detaiCat + "' name='detailCode'></td>";
                        markup += "<td><input type='text' readonly style='width: 100%' value='" + data + "' name='description'></td>";
                        markup += "<td><input type='text' style='width: 100%' name='detailBalance'></td>";
                        markup += "<td style='padding-left: 20px'><a onclick=deleteRow('tblVerification',this)><i  class=\"fa fa-trash-o fa-3x\"></i></a></td>";
                        markup += "</tr>";
