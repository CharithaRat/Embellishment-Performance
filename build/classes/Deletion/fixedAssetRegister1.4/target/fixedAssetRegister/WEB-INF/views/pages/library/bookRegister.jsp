        ...
        <div class="page">
            <form name="bookForm"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-4">PGIM ID</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class='input-group date'>
                                    <input type='text' class="form-control" style="width: 100%" required="required" name="date"/>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class='input-group date'>
                                    <input type='text' class="form-control" style="width: 100%" required="required" name="dateOfPublication"/>
                                    <span class="input-group-addon">
                                                <span class="glyphicon glyphicon-calendar"></span>
                                                </span>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <a class="btn btn-primary" style="width: 100%" href="${root}/library/bookRegistration">New</a>
                            </div>
                            <div class="col-md-4">
