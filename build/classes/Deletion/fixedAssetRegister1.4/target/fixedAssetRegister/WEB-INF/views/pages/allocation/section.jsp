                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <select id="departmentId" required name="departmentMaster.depId" style="width: 100%">
                                    <option value="">---SELECT---</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="uppercase" id="secCode" onkeyup="validateCharacter(this)"
                                       onblur="checkSectionCode(this),validateMasterCode(this)"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <textarea name="secDes" required="required" maxlength="35"
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        if (isEdit == 1) {
            ...
            // $("#companyId").prop("disabled", "disabled");
