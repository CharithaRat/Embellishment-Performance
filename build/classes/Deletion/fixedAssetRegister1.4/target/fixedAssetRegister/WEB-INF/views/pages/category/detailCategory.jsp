            ...
            <form name="detailsCatergoryForm" id="detailsCatergoryFormID"
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="text" width="100" id="detailCode" onkeyup="validateCharacter(this)"
                                       onblur="checkDetailCode(this)" onchange="validateMasterCode(this)"
                                       class="uppercase" required="required" maxlength="3" value="${detailCat.dcatCode}"
                                       name="dcatCode"
                                       style="width: 100%"/>
                            </div>
                            <div class="col-md-2"></div>
                        ...
                        <div class="row">
                            <div class="col-md-4">Depreciation Rate - Income Tax</div>
                            <div class="col-md-6">
                                <input type="text" width="100" id="depRateIncomeTaxId"
                                       onblur="validatePercentageField(this)" onkeyup="isNumber(this)"
                                       value="${detailCat.depRateIncomeTax}" name="depRateIncomeTax"
                                       style="width: 100%"/>
                            </div>
                            <div class="col-md-2"></div>
                        ...
                        <div class="row">
                            <div class="col-md-4">Depreciation Rate - Accounting</div>
                            <div class="col-md-6">
                                <input type="text" width="100" id="depRateAccountId"
                                       onblur="validatePercentageField(this)" onkeyup="isNumber(this)"
                                       value="${detailCat.depRateAccount}" name="depRateAccount"
                                       style="width: 100%"/>
                            </div>
                            <div class="col-md-2"></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <textarea name="dcatDes"  maxlength="35"
