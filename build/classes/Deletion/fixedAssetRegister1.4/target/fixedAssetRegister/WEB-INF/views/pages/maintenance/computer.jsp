                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" required style="width: 100%" id="operatingSystemId"
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" required style="width: 100%" id="computerTypeId"
                                       name="computerType"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" required style="width: 100%" id="batteryId" name="battery"/>
                            </div>
                        </div>
                    </div>
                <div class="col-md-2"></div>
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <input type="text" required style="width: 100%" id="brandId" name="brand"/>
                    </div>
                </div>
            </div>
            <div class="col-md-5">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <input type="text" required style="width: 100%" id="buyerId" name="buyer"/>
                    </div>
                </div>
            </div>
            <div class="col-md-2"></div>
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <input type="text" required style="width: 100%" id="deviceNameId" name="deviceName"/>
                    </div>
                </div>
            </div>
            <div class="col-md-5">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <input type="text" required style="width: 100%" id="buyerAddressId"
                               name="buyerAddress"/>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <input type="text" required style="width: 100%" id="lengthId" name="length"/>
                    </div>
                </div>
            </div>
            <div class="col-md-5">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <input type="text" required style="width: 100%" id="buyerTelId" name="buyerTel"/>
                    </div>
                </div>
            </div>
            <div class="col-md-2"></div>
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <input type="text" required style="width: 100%" id="widthId" name="width"/>
                    </div>
                </div>
            </div>
            <div class="col-md-5">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <input type="text" required style="width: 100%" id="computerColorId"
                               name="computerColor"/>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <input type="text" required style="width: 100%" id="heightId" name="height"/>
                    </div>
                </div>
            </div>
            <div class="col-md-5">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <input type="text" required style="width: 100%" id="processorId" name="processor"/>
                    </div>
                </div>
            </div>
            <div class="col-md-2"></div>
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <input type="text" required style="width: 100%" id="weightId" name="weight"/>
                    </div>
                </div>
            </div>
            <div class="col-md-5">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <input type="text" required style="width: 100%" id="adapterId" name="adapter"/>
                    </div>
                </div>
            </div>
            <div class="col-md-2"></div>
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <input type="text" required style="width: 100%" id="ramSizeId" name="ramSize"/>
                    </div>
                </div>
            </div>
            <div class="col-md-5">
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <input type="text" required style="width: 100%" id="deviceId" name="deviceId"/>
                    </div>
                </div>
            </div>
            <div class="col-md-5">
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" required style="width: 100%" id="productId" name="productId"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" required style="width: 100%" id="systemTypeId" name="systemType"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2"></div>
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" required style="width: 100%" id="monitorId" name="monitor"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" required style="width: 100%" id="hardDiskCapacityId" name="hardDiskCapacity"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2"></div>
